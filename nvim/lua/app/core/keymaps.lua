...
-- Buffers
keymap.set("n", "<C-o>", ":bnext<CR>", { noremap = true, silent = true })
keymap.set("n", "<C-i>", ":bprev<CR>", { noremap = true, silent = true })
-- Lines
...
keymap.set("n", "<C-+>", "<C-w>>", { noremap = true }) -- increment window width
keymap.set("n", "<C-=>", "<C-w><", { noremap = true }) -- decrement window width
-- vim-maximizer
